...
int main()
{
    ...
    if (true == client.isReady())
    {
        ...
        _SLEEP_MS(500)
        client.handleExtRequest(Interval_X, eLongDouble, 200000u);
        _SLEEP_MS(500)
        client.handleExtRequest(Interval_X, eFloat, 200000u);
        _SLEEP_MS(500)
        client.handleExtRequest(Interval_X, eDouble, 200000u);
    }
    return 0;
}
